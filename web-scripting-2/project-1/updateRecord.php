...
if (!isset($_POST['firstName']) || !isset($_POST['lastName']) || !isset($_POST['studentNumber'])) {
    send('allStudents.php?error=no_user');
}
...
<section>
    <form action="submitUpdatedRecord.php" method="POST">
        ...
        <div>
            ...
            <input type="text" name="originalStudentNumber" id="originalStudentNumber" value="<?= $studentNumber ?>" hidden>
        </div>

        <div>
            <label for="studentNumber">Student Number:</label>
            <input type="text" id="studentNumber" name="studentNumber" placeholder="Student Number" value="<?= $studentNumber ?>">
        </div>
